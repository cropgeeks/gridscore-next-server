...
public class SchemaVersionRecord extends UpdatableRecordImpl<SchemaVersionRecord> implements Record10<Integer, String, String, String, String, Integer, String, LocalDateTime, Integer, Byte> {

    private static final long serialVersionUID = 1L;

    /**
     * Setter for <code>gridscore_db.schema_version.installed_rank</code>.
     */
    ...
    /**
     * Getter for <code>gridscore_db.schema_version.installed_rank</code>.
     */
    ...
    /**
     * Setter for <code>gridscore_db.schema_version.version</code>.
     */
    ...
    /**
     * Getter for <code>gridscore_db.schema_version.version</code>.
     */
    ...
    /**
     * Setter for <code>gridscore_db.schema_version.description</code>.
     */
    ...
    /**
     * Getter for <code>gridscore_db.schema_version.description</code>.
     */
    ...
    /**
     * Setter for <code>gridscore_db.schema_version.type</code>.
     */
    ...
    /**
     * Getter for <code>gridscore_db.schema_version.type</code>.
     */
    ...
    /**
     * Setter for <code>gridscore_db.schema_version.script</code>.
     */
    ...
    /**
     * Getter for <code>gridscore_db.schema_version.script</code>.
     */
    ...
    /**
     * Setter for <code>gridscore_db.schema_version.checksum</code>.
     */
    ...
    /**
     * Getter for <code>gridscore_db.schema_version.checksum</code>.
     */
    ...
    /**
     * Setter for <code>gridscore_db.schema_version.installed_by</code>.
     */
    ...
    /**
     * Getter for <code>gridscore_db.schema_version.installed_by</code>.
     */
    ...
    /**
     * Setter for <code>gridscore_db.schema_version.installed_on</code>.
     */
    ...
    /**
     * Getter for <code>gridscore_db.schema_version.installed_on</code>.
     */
    ...
    /**
     * Setter for <code>gridscore_db.schema_version.execution_time</code>.
     */
    ...
    /**
     * Getter for <code>gridscore_db.schema_version.execution_time</code>.
     */
    ...
    /**
     * Setter for <code>gridscore_db.schema_version.success</code>.
     */
    ...
    /**
     * Getter for <code>gridscore_db.schema_version.success</code>.
     */
    ...
    @Override
    public SchemaVersionRecord values(Integer value1, String value2, String value3, String value4, String value5, Integer value6, String value7, LocalDateTime value8, Integer value9, Byte value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public SchemaVersionRecord(Integer installedRank, String version, String description, String type, String script, Integer checksum, String installedBy, LocalDateTime installedOn, Integer executionTime, Byte success) {
        super(SchemaVersion.SCHEMA_VERSION);
     ...
     * Create a detached, initialised SchemaVersionRecord
     */
    public SchemaVersionRecord(jhi.gridscore.server.database.codegen.tables.pojos.SchemaVersion value) {
        super(SchemaVersion.SCHEMA_VERSION);
